...
import com.chiragkawediya.langmaker.gui.util.ConsonantRow;
...
import com.chiragkawediya.langmaker.langcomponents.alphabet.Phone;
import com.chiragkawediya.langmaker.langcomponents.alphabet.Phoneme;
...
public class PhonologyTabController {
    ...
    private void addPhoneme() {
        ...
        Phoneme p = new Phoneme((ArrayList<Phone>)((ArrayList)currentPronunciation).clone(), symbol, type);
        language.alphabet.addPhoneme(p);

        p.setNotes(noteBox.getText());
    ...
    private void addNotes() {
        ...
        try {
            ...
            alert.setHeaderText("You need to select a phoneme from your alphabet to add notes to it!");

            alert.setContentText("Select the type, " +
                    "then add vowels and consonants to show the pronounciation " + "" +
                    "finally");
